...
- Маски:
  ...
  - Set Scale — два клика задают, сколько пикселей в указанном отрезке (по умолчанию 1 м; поле можно менять); ширина маски пересчитывается автоматически.
...
- Масштаб/качество:
  ...
  - Ресэмплер: Lanczos или Kaiser (beta/radius), кеширование. Kaiser — экспериментальный, может работать заметно дольше.
- Канвас:
